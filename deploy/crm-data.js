...
(function () {
  ...
  // ✅ SITE COMPLETAMENTE ZERADO
  // Todos os dados vêm do Firebase Firestore
  // Nenhum dado fictício pré-carregado

  const seedProperties = [];
  const seedLeads = [];

  const seedPosts = [];     // ✅ ZERADO - Nenhum artigo fictício
  const seedTestimonials = [];  // ✅ ZERADO - Nenhum depoimento fictício
